...
function EventsCreate() {
      ...
      if (
        ...
        if (size > 2) {
          ...
          setForm({
            ...
            [e.target.name]: e.data.data.name,
          });
        }
      } else {
        setAlert({
  ...
  const handleMinusKeyPont = (index) => {
    let _temp = [...form.keyPoint];
  ...
  return (
    <Container>
      ...
      <Form
        ...
        handlePlusKeyPoint={handlePlusKeyPont}
        handleMinusKeyPoint={handleMinusKeyPont}
